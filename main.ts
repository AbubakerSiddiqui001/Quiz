...
// Print user Score number 
console.log(` \n Your score is: ${chalk.yellowBright (score)} \n`);

// user score ahead & equal 3 then print 'if' statement
if (score >= 3) {
    console.log(chalk.yellowBright (" \n \t Good luck"));
}

// If user doesn't acheive 3 number , then print 'Else statement'
else {
